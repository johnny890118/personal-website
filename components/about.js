  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col items-center justify-center">
        ...
        <div className="flex w-[90%] flex-col rounded-3xl border border-gray-100 bg-gray-400 bg-opacity-10 p-12 backdrop-blur-md backdrop-filter md:h-[80%] md:w-[70%] md:flex-row">
          <motion.div
          ...
          >
            <p>
              哈囉您好，我是政軒，對前端開發充滿熱情的人。
              <br />
              <br />
              個性活潑開朗，喜歡帶給身邊的人歡樂，善於溝通及團隊合作。
              <br />
              <br />
              1.畢業於義守大學通訊工程系（現已改名智慧網路工程系）
              <br />
              2.於榮興自動化擔任軟體工程師，目前8個月工作經驗
              <br />
              ...
              ｜熱情旅程｜
              <br />
              我是蔡政軒，從小就非常喜歡美術，對工程師的世界也抱有極大的興趣和好奇。當發現可以將這兩者結合時，我毫不猶豫地踏上了前端開發之旅。這段旅程不僅讓我深深愛上了前端技術，更享受將設計與技術融合的樂趣。
              <br />
              <br />
              ｜前端之愛｜
              <br />
